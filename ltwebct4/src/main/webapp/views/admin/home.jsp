...
<body class="container mt-4 mb-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="${pageContext.request.contextPath}/admin/categories" class="card dashboard-card">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="card-title mb-1">Quản lý loại hàng</h5>
                            <p class="card-desc mb-0">Thêm, sửa, xóa danh mục</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="card-desc mb-0">Kho hàng, giá cả, tồn kho</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="card-desc mb-0">Doanh thu, đơn hàng</p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-md-6 col-lg-4">
            <a href="${pageContext.request.contextPath}/logout" class="card dashboard-card border-danger border-opacity-25">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
